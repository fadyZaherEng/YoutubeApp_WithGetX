...
class DesignsPatternsController extends GetxController {
  ...
  static DesignsPatternsController get to => Get.find();
  ...
  void _loadVideos() async {
    YoutubeResponseBasedQ youtubeVideoResult= await youtuberRepository
        .loadDesignPatternsVideos(youtubeResponseBasedQ.value.nextPageToken ?? "");
