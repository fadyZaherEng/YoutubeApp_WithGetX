  ...
  Widget _buttonZone() {
    return Obx(() => Row(
      ...
      children: [
        ...
        _buttonOne("dislike", controller.statistics.value.dislikeCount.toString()),
      ...
      child: Obx(() => Row(
        children: [
          CircleAvatar(
            ...
            backgroundImage: Image.network(controller.youtuber.value.snippet!.thumbnails!.medium!.url).image,
          ),
          SizedBox(width: 15),
          Expanded(
            child: Column(
